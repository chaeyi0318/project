...
<body>
    ...
    <li class="side2">
        ...
        <ul class="sub2" style="display:none">
            ...
            <li><a href="${contextPath}/production/decideInfo.do"  class="no-underline">작업지시확정</a><br></li>
    ...
    <li class="side3">
        ...
        <ul class="sub3" style="display:none">
            <li><a href="${contextPath}/information/bomPage.do"  class="no-underline">BOM등록</a><br></li>
