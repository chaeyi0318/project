...
<body>
    ...
    <c:if test="${company == null }">
    	<form align="center" method="post" action="${contextPath }/system/insertCompany.do">
            ...
            <h4>회계연도 제 <input type="text" name="cardinal" size=1> 기 
            <input type="date" name="startDate"> - <input type="date" name="endDate"></h4><br>
            ...
            <h4>주민등록번호 <select id="forign" name="forign" class="sel">
                           ...
                           </select> <input type="text" name="residentNum" value=""></h4><br>
