...
<body>
    <div id="wrap">
        <form align="center" method="post">
            <h2>회사명 <input type="text" name="comName" size="20px" value="${company.comName }" required>
            ...
            <select id="tax" name="tax" class="sel" aria-label="과세" value="${company.cardinal }">
            	<option value="${company.cardinal }">구분</option>
            ...
            <h4>
                ...
                주소 : <input type="text" name="address" style="width:300px; height:20px;" value="${company.address }" readonly /><br>
            ...
            <h4>폐업연월일 <input type="date" id="closeDate" name="closeDate" value="${company.closeDate }" min="1900-01-01" max="2100-12-31"></h4>
        </form>
    </div>
</body>
</html>